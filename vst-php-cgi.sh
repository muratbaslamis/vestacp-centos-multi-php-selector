...
site_link="https://raw.githubusercontent.com/muratbaslamis/vestacp-centos-multi-php-selector/main/cgi"
...
for ver in $vers; do
    ...
    wget $site_link/phpcgi-$ver.stpl -O /usr/local/vesta/data/templates/web/httpd/phpcgi-$ver.stpl
    wget $site_link/phpcgi-$ver.tpl -O /usr/local/vesta/data/templates/web/httpd/phpcgi-$ver.tpl
    wget $site_link/phpcgi-$ver.sh -O /usr/local/vesta/data/templates/web/httpd/phpcgi-$ver.sh
    chmod a+x /usr/local/vesta/data/templates/web/httpd/phpcgi-$ver.sh
